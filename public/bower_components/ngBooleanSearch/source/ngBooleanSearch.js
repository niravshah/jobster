(function (window, angular, undefined) {
    ...
    module.provider('ngBooleanSearch', function(){
        ...
        var patterns = ['aspirations:', 'tag:', 'url:', 'title:'];
        ...
        this.$get = [function () {
            ...
            var evaluateExpression = function(bookmark, node){
                ...
                if(node.pattern === 'aspirations:'){
                    evaluateFunc = function(word){ return containsTag(bookmark.aspirations, word); };
                }              
                else if(node.pattern === 'tag:'){
            ...
            var generateExpressionTree = function(searchText){
                ...
                var searchWords = searchText.split(/(aspirations:|tag:|title:|url:)/);
